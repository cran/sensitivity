...
PLIquantile = function(order,x,y,quantilehat,deltasvector,
  ...
  # Author: Paul Lemaitre, Bertrand Iooss and Thibault Delage
  ...
  # quantilehat is an estimation of the quantile of the output.
